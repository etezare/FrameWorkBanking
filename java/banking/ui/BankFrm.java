...
//			}
	...
	private void loadAll() {
		...
		for (Account account : accounts) {
			...
			rowdata[2] = "city";
			rowdata[3] = account.getCustomer() == null ? "" : account.getCustomer().getType();
			rowdata[4] = account instanceof CheckingAccount ? AccountFactory.CHECKING : AccountFactory.SAVING;
